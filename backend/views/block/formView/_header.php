...
<div class="row mt-md-3 mt-0">    
    <div class="col-md-6 col-12">
        <!-- Immagine anteprima singola -->
        <?php echo $form->field($image, 'imageMobile')->widget(FileInput::classname(), [
                        'name' => 'imageMobile',
                        'options' => [
                            'accept' => 'image/*',
                            'multiple' => false, 
                        ...
                        'pluginOptions' => [
                            'maxFileCount' => 1,
                            'initialPreview'=>$listPreviewMobileImg,
                            'initialPreviewConfig' =>  $initialImgMobilePreviewConfig,
                            'initialPreviewAsData'=>true,
                            'overwriteInitial'=>false,
                            'deleteUrl' => Url::to(['update', 'id' => $model->id]),
                        ]            
                    ])->label('Aggiungi Immagine Mobile');
        ?>
    </div>
</div><!-- end::row -->
