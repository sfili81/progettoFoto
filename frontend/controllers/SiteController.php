 ...
 * Site controller
 */
class SiteController extends BaseTranslateController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            //Commento per mostrare la mia action degli errori
            /*'error' => [
    ...
    /**
     * Displays twig example view.
     *
     * @return mixed
     */
    public function actionTwigExample()
    {
        return $this->render('twigView.twig');
    }
    ...
    public function actionContact()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->sendEmail($model) && $model->validate()) {
    ...
    public function actionNews()
    {
        ...
        $model = News::findOne(['id' => 2]);
        //dd($model->getBehavior('translatable')->language);
